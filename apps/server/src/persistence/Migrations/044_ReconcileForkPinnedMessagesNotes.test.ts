...
layer("044_ReconcileForkPinnedMessagesNotes", (it) => {
  it.effect("heals fork DBs whose migration 40 was workspace contexts", () =>
    Effect.gen(function* () {
      ...
      yield* sql`
        ...
        VALUES (40, 'ProjectionThreadWorkspaceContexts')
      `;
